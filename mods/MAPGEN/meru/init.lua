...
local BASRAD = 52 -- Average radius at y = -32
local HEIGHT = 1848 -- Approximate height measured from y = -32
local CONVEX = 1 -- Convexity. <1 = concave, 1 = conical, >1 = convex
local VOID = 0.04 -- Void threshold. Controls size of central void
local NOISYRAD = 0.04 -- Noisyness of structure at base radius.
						-- 0 = smooth geometric form, 0.3 = noisy.
local NOISYCEN = 0.01 -- Noisyness of structure at centre
...
local FISEXPBAS = 0.06 -- Fissure expansion rate under surface at base
local FISEXPTOP = 0.09 -- Fissure expansion rate under surface at top
