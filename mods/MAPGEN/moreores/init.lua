...
local oredefs = {
	...
	mithril = {
		...
		tools = {
			pick = {
				cracky = {times = {[1] = 0.5, [2] = 0.2, [3] = 0.1}, uses = 200, maxlevel= 1}
			},
			hoe = {
				uses = 1000
			},
			shovel = {
				crumbly = {times = {[1] = 0.5, [2] = 0.2, [3] = 0.1}, uses = 200, maxlevel= 1}
			},
			axe = {
				choppy = {times = {[1] = 1.2, [2] = 0.45, [3] = 0.45}, uses = 200, maxlevel= 1},
				fleshy = {times = {[2] = 0.6, [3] = 0.30}, uses = 200, maxlevel= 1}
			},
			sword = {
				fleshy = {times = {[2] = 0.2, [3] = 0.25}, uses = 200, maxlevel= 1},
				snappy = {times = {[2] = 0.2, [3] = 0.25}, uses = 200, maxlevel= 1},
				choppy = {times = {[3] = 0.2}, uses = 200, maxlevel= 0}
			}
		},
