...
local np_cave = {
	offset = 0,
	scale = 2,
	spread = {x = 3284, y = 1228, z = 3284}, -- squashed 3:1
	seed = 590333,
	octaves = 5,
	persist = 0.7,
	lacunarity = 1.0,
...
local function nether_blocks_stairs(nodename, def)	
	...
	elseif minetest.get_modpath("stairs") and not( nodename == "nether:glowstone" ) then	
...
nether_blocks_stairs("nether:rack", {
...
nether_blocks_stairs("nether:glowstone", {
...
nether_blocks_stairs("nether:brick", {
