...
minetest.register_node("default:npc_spawner", {
	description = "NPC Spawner",
	tiles = {"halo.png"},
	is_ground_content = false,
	groups = {crumbly=1}})
minetest.register_abm({
	nodenames = {"default:npc_spawner"},
	interval = 3.0,
	chance = 0,
...
minetest.register_node("default:pumpkin", {
	description = "Magical Pumpkin",
	tiles = {"default_pumpkin.png"},
	groups = {snappy=1,},
	drop = 'default:pumpkin',
	legacy_mineral = not true,
	sounds = default.node_sound_defaults(),
})


minetest.register_node("default:magestone", {
	description = "Magic Rock",
	tiles = {"default_magestone.png"},
	is_ground_content = false,
	paramtype2 = "airlike",
	sounds = default.node_sound_defaults(),
	groups = {cracky = 10},
