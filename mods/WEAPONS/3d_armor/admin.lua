...
minetest.register_tool("3d_armor:helmet_admin", {
	...
	groups = {armor_head=1000, armor_heal=1000, armor_use=0, armor_water=1, not_in_creative_inventory=0},
	wear = 0,
...
minetest.register_tool("3d_armor:chestplate_admin", {
	...
	groups = {armor_torso=1000, armor_heal=1000, armor_use=0, not_in_creative_inventory=0},
	wear = 0,
	on_drop = function(itemstack, dropper, pos)
		return
	end,
...
minetest.register_tool("3d_armor:leggings_admin", {
	...
	groups = {armor_legs=1000, armor_heal=1000, armor_use=0, not_in_creative_inventory=0},
	wear = 0,
	on_drop = function(itemstack, dropper, pos)
		return
	end,
...
minetest.register_tool("3d_armor:boots_admin", {
	...
	groups = {armor_feet=1000, armor_heal=1000, armor_use=0, not_in_creative_inventory=0},
	wear = 0,
	on_drop = function(itemstack, dropper, pos)
		return
	end,
