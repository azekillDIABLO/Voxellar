...
local oredefs = {
	...
	spectrite = {
		description = "Spectrite",
		makes = {ore = true, block = true, lump = true, ingot = true, chest = false},
		oredef = {clust_scarcity = moreores_spectrite_chunk_size * moreores_spectrite_chunk_size * moreores_spectrite_chunk_size,
			clust_num_ores = moreores_spectrite_ore_per_chunk,
			clust_size     = moreores_spectrite_chunk_size,
			y_min     = moreores_spectrite_min_depth,
			y_max     = moreores_spectrite_max_depth
			},
		tools = {
			pick = {
				cracky = {times = {[1] = 2.25, [2] = 0.55, [3] = 0.35}, uses = 200, maxlevel= 1}
